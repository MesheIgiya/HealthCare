...
<html lang="en">
  ...
  <body>
    ...
    <div
      class="relative z-10 min-w-screen min-h-screen bg-white-300 flex items-center justify-center px-5 py-5"
      id="login">
      <div
        class="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden"
        style="max-width: 1000px">
        <div class="md:flex w-full">
          <div class="hidden md:block w-1/2 bg-teal-400 py-10 px-10">
            <svg
            ...
            <div>
              <form id="login_form">
                  ...
                  <div class="w-full px-3 mb-5">
                    ...
                    <div class="flex">
                      <div
                        ...
                        <i
                          class="mdi mdi-email-outline text-gray-400 text-lg"></i>
                      </div>
                      <input
                        type="text"
                        name="username"
                  ...
                  <div class="w-full px-3 mb-12">
                    ...
                    <div class="flex">
                      <div
                        class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                        <i
                          class="mdi mdi-lock-outline text-gray-400 text-lg"></i>
                      </div>
                      <input
                        type="password"
                        name="password"
                ...
                <div class="flex -mx-3">
                  <div class="w-full px-3 mb-5">
                    <button
                      class="block w-full max-w-xs mx-auto bg-teal-400 hover:bg-teal-600 focus:bg-teal-600 text-white rounded-lg px-3 py-3 font-semibold"
                      id="submit_login">
                      LOGIN
                    </button>
    ...
    <div
      class="min-w-screen min-h-screen bg-white-300 flex items-center justify-center px-5 py-5"
      id="register">
      <div
        class="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden"
        style="max-width: 1000px">
              ...
              <form id="registration_form">
                ...
                <div class="flex -mx-3">
                  <div class="w-full px-3 mb-5">
                    ...
                    <p class="text-center text-blue-500">
                      <a id="login_btn" class="cursor-pointer hover:underline"
                        >Login</a
                      >
                    </p>
                  </div>
